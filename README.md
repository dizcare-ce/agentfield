...
<!-- All outbound agentfield.ai links must use UTM parameters, not direct URLs. See assets/utm-links.csv for the full list. Update both the README and the CSV when adding or changing links. -->
